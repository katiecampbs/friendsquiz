...
let questions = quizData.questionList;
    ...
    function checkAnswer(answer, button) {
        ...
        setTimeout(function () {
            ...
            if (currentQuestionIndex < questions.length) {
                ...
                scoreContainer.innerHTML = `<div class="score-container-styling"><h1>Quiz Score</h1><p>You scored: ${score} out of 15!</p></div>`;
            }
        }, 1000);
    }
};
...
refreshBtn.addEventListener("click", handleClick);// Import the questionList from the external file
